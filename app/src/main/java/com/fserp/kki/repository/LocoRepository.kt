...
class LocoRepository {
    ...
    fun Loco(comcode:String,shedcode:String): MutableLiveData<List<AllData>> {
        ...
        praments.PLOCONO = ""
        praments.PSERIALNO = ""
        praments.EXTRA2 =shedcode
        praments.EXTRA3 = "RS"
        APIClients.newsInstance.getLoco(praments)?.enqueue(object : Callback<Responses?> {
