...
class ComplaintNatureRepository {
    fun complaintnature(comcode: String): MutableLiveData<List<AllData>>
    {
        ...
        APIClients.newsInstance.getComplaintNature(praments)?.enqueue(object : Callback<Responses?> {
