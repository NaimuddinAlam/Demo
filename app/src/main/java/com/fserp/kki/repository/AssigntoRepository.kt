...
class AssigntoRepository {
    fun assingto(comcode: String): MutableLiveData<List<AllData>>
    {
        ...
        APIClients.newsInstance.getAssingto(praments)?.enqueue(object : Callback<Responses?> {
